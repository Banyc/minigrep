...
pub fn grep(config: &grep_config::GrepConfig) -> Result<GrepResult, GrepError> {
    ...
    for filename in &config.filenames {
        ...
        let file_matches = grep_single_file(&single_file_config)?;
...
fn grep_single_file(config: &GrepSingleFileConfig) -> Result<Vec<LineResult>, GrepError> {
